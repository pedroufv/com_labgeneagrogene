 ...
 * @since  1.6
 */
class LabgeneagrogeneViewRequest extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_LABGENEAGROGENE_REQUEST'), 'file-2');
		...
		JToolBarHelper::custom('request.printer', 'print', 'print', 'JTOOLBAR_LABGENEAGROGENE_PRINT', false);

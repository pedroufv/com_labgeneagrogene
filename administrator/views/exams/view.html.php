 ...
 */
class LabgeneagrogeneViewExams extends JViewLegacy
{
    ...
    public function display($tpl = null)
    {
        ...
        // Load the submenu.
        LabgeneagrogeneHelper::addSubmenu('exams');
    ...
    protected function addToolbar()
    {
        ...
        JToolBarHelper::title(JText::_('COM_LABGENEAGROGENE_EXAMS'), 'health');
        ...
        JHtmlSidebar::setAction('index.php?option=com_labgeneagrogene&view=exams');

        $this->extra_sidebar = '';
        JHtmlSidebar::addFilter(
            JText::_("JOPTION_SELECT_CATEGORY"),
            'filter_catid',
            JHtml::_('select.options', JHtml::_('category.options', 'com_labgeneagrogene'), "value", "text", $this->state->get('filter.catid'))
        );
	...
	protected function getSortFields()
	{
		return array(
            ...
            'a.`catid`' => JText::_('COM_LABGENEAGROGENE_CATID'),
            'a.`title`' => JText::_('COM_LABGENEAGROGENE_TITLE'),
            'a.`code`' => JText::_('COM_LABGENEAGROGENE_CODE'),

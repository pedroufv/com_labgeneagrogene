...
if ($saveOrder)
{
    $saveOrderingUrl = 'index.php?option=com_labgeneagrogene&task=requests.saveOrderAjax&tmpl=component';
            ...
            <?php foreach ($this->items as $i => $item) :
                ...
                <tr class="row<?php echo $i % 2; ?>">
                    ...
                    <td class="center hidden-phone">
                        <a href="<?php echo JRoute::_('index.php?option=com_labgeneagrogene&task=request.edit&id='.(int) $item->id); ?>">
